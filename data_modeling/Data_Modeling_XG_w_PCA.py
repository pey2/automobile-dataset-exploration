...
# MAGIC - The accuracy of the model is 73%
# MAGIC - The model is confident and mostly correct on class 0 (Precision of 92%) and lowest for class 3 (Precision of 50%)
# MAGIC - The model correctly found the number of actual positives on class 1 (Recall of 100%) and lowest on class 2 (Recall of 60%)
# MAGIC - The model performs best mostly on classes 0 and 1
