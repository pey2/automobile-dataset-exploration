...
# MAGIC %md
# MAGIC ## Data Modelling Using Support Vector Machine

# COMMAND ----------

# MAGIC %md
# MAGIC ### With One-vs-One

# COMMAND ----------

svm_ovo = SVC(kernel="rbf", gamma=1, C=0.5, decision_function_shape="ovo", random_state=42)
svm_ovo.fit(X_train_resampled, y_train_resampled)
...
# MAGIC %md
# MAGIC ### With One-vs-Rest

# COMMAND ----------

svm_ovr = SVC(kernel="rbf", gamma=1, C=0.5, decision_function_shape="ovr", random_state=42)
svm_ovr.fit(X_train_resampled, y_train_resampled)
